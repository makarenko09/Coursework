...
//    }
    ...
    public static Employee findEmployeeWithMinSalary(Employee[] employees, Integer... department) {
    ...
    //
    public static Employee findEmployeeWithMaxSalary(Employee[] employees, Integer... department) {
